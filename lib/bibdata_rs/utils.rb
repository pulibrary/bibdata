...
module BibdataRs
  ...
  # This class is responsible for updating the Rust function that looks up ISO 639-2b language data by code
  ...
  class UpdateIso6395LanguageData < UpdateIso6392bLanguageData
    private

      def iso_function
        <<~END_ISO_639_5_FUNCTION.chomp
          // This file is automatically generated.  Please do not edit it directly,
        ...
        END_ISO_639_5_FUNCTION
      end

      def languages
        download = URI.open('https://id.loc.gov/vocabulary/iso639-5.tsv')
        CSV.new(download, col_sep: "\t", headers: true).filter_map do |row|
          language_code = row['code']
          language_struct = Language.new(row['Label (English)'])
          "\"#{language_code}\" => #{language_struct.as_rust_language_option}"
        end
      end
  end
end
