...
use crate::marc::{
    ...
    non_latin::{
        NON_LATIN_SERIES_TITLE_TAGS, NON_LATIN_TITLE_TAGS, non_latin_series_title_subfields,
        non_latin_title_subfields,
    },
    trim_punctuation,
...
pub fn cjk_titles(record: &Record) -> impl Iterator<Item = String> {
    let title_fields =
