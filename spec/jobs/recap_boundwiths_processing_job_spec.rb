...
RSpec.describe RecapBoundwithsProcessingJob do
  ...
  describe ".perform" do
    context "with records in the cache" do
      before do
  ...
  context "with records missing from the cache" do
    it "raises an exception" do
      dump = FactoryBot.create(:recap_incremental_dump)
      expect { described_class.perform_now(dump) }.to raise_error(AlmaAdapter::ScsbDumpRecord::CacheMiss, /9929455783506421,9929455793506421,99116515383506421/)
    end
  end
end
