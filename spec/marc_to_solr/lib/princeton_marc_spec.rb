  ...
  describe '#electronic_access_links' do
    ...
    context 'with a URL for an ARK' do
      ...
      it 'retrieves the URL for the current resource' do
        expect(links).to include('https://catalog.princeton.edu/catalog/4765221#viewer-container' => ['Digital content'])
        expect(links).to include('https://catalog.princeton.edu/catalog/4765221#viewer-container_1' => ['Digital content', 'label'])
        expect(links).to include('https://catalog.princeton.edu/catalog/4765221#viewer-container_2' => ['Selected images'])
